...
public class JedisClusterPipeline extends PipelineBase implements Closeable {
    ...
    private static final Logger LOGGER = Logger.getLogger(JedisClusterPipeline.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        nodes.add(new HostAndPort("192.168.159.132", 7000));
        nodes.add(new HostAndPort("192.168.159.134", 7000));
        nodes.add(new HostAndPort("192.168.159.135", 7000));
